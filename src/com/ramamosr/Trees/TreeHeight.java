...
Explanation 2:
 ...
 Distance of node having value 2 from root node = 3 (max)
    ...
    /*
    If the root node is Null, then we can simply say the height is 0.
Else the height of the tree will be 1 + (maximum out of left child's subtree height and right child's subtree height).
     */
